...
image1 = tk.PhotoImage(file='C:\\Users\\Sagar\\Downloads\\All-in-One-Unit-Converter\\bg.png')
w = image1.width()
h = image1.height()
panel1 = tk.Label(root, image=image1)
panel1.pack(side='top', fill='both', expand='yes')
panel1.image = image1
widget = Button(None, text="Exit ",width = 20,height=1, bg="white", fg="black",font = ("times new roman", 14, "bold"), relief = RAISED, bd=1, activebackground = "white", activeforeground="black", command=root.destroy).place(x=260,y=100)
...
widget = Button(root, text="    Length Converter     ", bg="skyblue" , fg="black",font = ("times new roman", 14, "bold"), relief = RAISED, bd=1, justify = CENTER, highlightbackground = "red", overrelief = GROOVE, activebackground = "black", activeforeground="blue", command=LengthConverter).place(x=0,y=100)
