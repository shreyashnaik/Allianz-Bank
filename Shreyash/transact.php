    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav text-uppercase text-info ml-auto">
        ...
        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="transfermoney.php">Transfer Money</a></li>
         <li class="nav-item"><a class="nav-link js-scroll-trigger" href="transactionhistory.php">Transfer History</a></li>
            ...
            <form method="post" name="tcredit" class="tabletext" ><br>
                ...
                <select name="to" class="form-control" required>
                    ...
                    <div class="text-center" >
                        <button class="btn bg-info" name="submit" type="submit" id="myBtn">Transfer</button>
                        <div>
                            </br>
                        </div>
                    </div>
